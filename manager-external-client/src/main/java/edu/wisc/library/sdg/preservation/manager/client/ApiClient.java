package edu.wisc.library.sdg.preservation.manager.client;
...
import edu.wisc.library.sdg.preservation.manager.client.auth.Authentication;
import edu.wisc.library.sdg.preservation.manager.client.auth.ApiKeyAuth;

@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
@Component("edu.wisc.library.sdg.preservation.manager.client.ApiClient")
public class ApiClient extends JavaTimeFormatter {
    ...
    private String basePath = "http://localhost:8484/api";
