...
public class IngestEventCountITest extends ITestBase {
    ...
    private void setupEventsFor(edu.wisc.library.sdg.preservation.manager.client.internal.model.EventType type,
        ...
        recordIngestEvent(1L, defaultObject1.externalId, event);
    }
    ...
    private SystemEventCountsResponse getResponse(LocalDate start, LocalDate end, List<EventType> types, List<EventOutcome> outcomes, String org) {
        return serviceAdminUserClient.getIngestEventCounts(start, end, types, outcomes, org);
    }
    ...
    public void regularUserIsDeniedAccess() {
        assertThrows(AccessDeniedException.class, () ->
                regularUserClient.getIngestEventCounts(LocalDate.now().minusDays(1),
    ...
    public void adminUserIsDeniedAccess() {
        assertThrows(AccessDeniedException.class, () ->
                adminUserClient.getIngestEventCounts(LocalDate.now().minusDays(1),
                        LocalDate.now(), null, null, null));
    }
    ...
    public void serviceAdminUserIsAllowed() {
        assertDoesNotThrow(() ->
                serviceAdminUserClient.getIngestEventCounts(LocalDate.now().minusDays(1),
                LocalDate.now(), null, null, null));
    }
    ...
    public void returnsExpectedCounts() {
        ...
        assertCountsFor(receiveBagCounts, 3L, 0L, null, null, null, null);
    }
