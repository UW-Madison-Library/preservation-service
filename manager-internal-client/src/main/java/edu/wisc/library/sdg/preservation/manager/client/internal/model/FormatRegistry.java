...
/**
 * Registry of format identifiers
 */
public enum FormatRegistry {
  ...
  @JsonCreator
  public static FormatRegistry fromValue(String value) {
    for (FormatRegistry b : FormatRegistry.values()) {
