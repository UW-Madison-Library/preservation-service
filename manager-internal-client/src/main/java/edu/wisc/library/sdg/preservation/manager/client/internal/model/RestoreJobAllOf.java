 ...
 */
@JsonPropertyOrder({
  RestoreJobAllOf.JSON_PROPERTY_INTERNAL_OBJECT_ID,
  RestoreJobAllOf.JSON_PROPERTY_PERSISTENCE_VERSION,
  RestoreJobAllOf.JSON_PROPERTY_SOURCE,
  RestoreJobAllOf.JSON_PROPERTY_KEY,
  RestoreJobAllOf.JSON_PROPERTY_SHA256_DIGEST
})
@JsonTypeName("RestoreJob_allOf")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class RestoreJobAllOf {
  ...
  public RestoreJobAllOf() { 
  }

  public RestoreJobAllOf internalObjectId(String internalObjectId) {
  ...
  **/
  ...
  public RestoreJobAllOf persistenceVersion(String persistenceVersion) {
  ...
  **/
  ...
  public RestoreJobAllOf source(DataStore source) {
  ...
  **/
  ...
  public RestoreJobAllOf key(String key) {
  ...
  **/
  ...
  public RestoreJobAllOf sha256Digest(String sha256Digest) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RestoreJobAllOf restoreJobAllOf = (RestoreJobAllOf) o;
    return Objects.equals(this.internalObjectId, restoreJobAllOf.internalObjectId) &&
        Objects.equals(this.persistenceVersion, restoreJobAllOf.persistenceVersion) &&
        Objects.equals(this.source, restoreJobAllOf.source) &&
        Objects.equals(this.key, restoreJobAllOf.key) &&
        Objects.equals(this.sha256Digest, restoreJobAllOf.sha256Digest);
  }

  @Override
  public int hashCode() {
    return Objects.hash(internalObjectId, persistenceVersion, source, key, sha256Digest);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RestoreJobAllOf {\n");
