...
import edu.wisc.library.sdg.preservation.manager.client.internal.model.ValidateRemoteJobAllOf;
 ...
 */
@JsonPropertyOrder({
  ValidateRemoteJob.JSON_PROPERTY_JOB_ID,
  ValidateRemoteJob.JSON_PROPERTY_INTERNAL_OBJECT_ID,
  ValidateRemoteJob.JSON_PROPERTY_PERSISTENCE_VERSION,
  ValidateRemoteJob.JSON_PROPERTY_DATA_STORE,
  ValidateRemoteJob.JSON_PROPERTY_DATA_STORE_KEY,
  ValidateRemoteJob.JSON_PROPERTY_SHA256_DIGEST
})
@JsonTypeName("ValidateRemoteJob")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class ValidateRemoteJob {
  ...
  public ValidateRemoteJob() { 
  }

  public ValidateRemoteJob jobId(Long jobId) {
  ...
  **/
  ...
  public ValidateRemoteJob internalObjectId(String internalObjectId) {
  ...
  **/
  ...
  public ValidateRemoteJob persistenceVersion(String persistenceVersion) {
  ...
  **/
  ...
  public ValidateRemoteJob dataStore(DataStore dataStore) {
  ...
  **/
  ...
  public ValidateRemoteJob dataStoreKey(String dataStoreKey) {
  ...
  **/
  ...
  public ValidateRemoteJob sha256Digest(String sha256Digest) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ValidateRemoteJob validateRemoteJob = (ValidateRemoteJob) o;
    return Objects.equals(this.jobId, validateRemoteJob.jobId) &&
        Objects.equals(this.internalObjectId, validateRemoteJob.internalObjectId) &&
        Objects.equals(this.persistenceVersion, validateRemoteJob.persistenceVersion) &&
        Objects.equals(this.dataStore, validateRemoteJob.dataStore) &&
        Objects.equals(this.dataStoreKey, validateRemoteJob.dataStoreKey) &&
        Objects.equals(this.sha256Digest, validateRemoteJob.sha256Digest);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobId, internalObjectId, persistenceVersion, dataStore, dataStoreKey, sha256Digest);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ValidateRemoteJob {\n");
