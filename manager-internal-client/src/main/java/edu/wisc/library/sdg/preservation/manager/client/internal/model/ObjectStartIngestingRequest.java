 ...
 */
@JsonPropertyOrder({
  ObjectStartIngestingRequest.JSON_PROPERTY_INGEST_ID,
  ObjectStartIngestingRequest.JSON_PROPERTY_EXTERNAL_OBJECT_ID
})
@JsonTypeName("ObjectStartIngestingRequest")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class ObjectStartIngestingRequest {
  ...
  public ObjectStartIngestingRequest() { 
  }

  public ObjectStartIngestingRequest ingestId(Long ingestId) {
  ...
  **/
  ...
  public ObjectStartIngestingRequest externalObjectId(String externalObjectId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObjectStartIngestingRequest objectStartIngestingRequest = (ObjectStartIngestingRequest) o;
    return Objects.equals(this.ingestId, objectStartIngestingRequest.ingestId) &&
        Objects.equals(this.externalObjectId, objectStartIngestingRequest.externalObjectId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ingestId, externalObjectId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ObjectStartIngestingRequest {\n");
