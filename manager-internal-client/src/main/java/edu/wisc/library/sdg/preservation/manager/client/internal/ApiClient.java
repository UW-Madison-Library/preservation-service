package edu.wisc.library.sdg.preservation.manager.client.internal;
...
import edu.wisc.library.sdg.preservation.manager.client.internal.auth.Authentication;
import edu.wisc.library.sdg.preservation.manager.client.internal.auth.HttpBasicAuth;

@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
@Component("edu.wisc.library.sdg.preservation.manager.client.internal.ApiClient")
public class ApiClient extends JavaTimeFormatter {
    ...
    private String basePath = "http://localhost:8484/internal/api";
