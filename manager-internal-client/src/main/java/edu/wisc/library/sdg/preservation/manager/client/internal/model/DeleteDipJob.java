...
import edu.wisc.library.sdg.preservation.manager.client.internal.model.DeleteDipJobAllOf;
 ...
 */
@JsonPropertyOrder({
  DeleteDipJob.JSON_PROPERTY_JOB_ID,
  DeleteDipJob.JSON_PROPERTY_RETRIEVE_REQUEST_ID,
  DeleteDipJob.JSON_PROPERTY_RETRIEVE_JOB_IDS
})
@JsonTypeName("DeleteDipJob")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class DeleteDipJob {
  ...
  public DeleteDipJob jobId(Long jobId) {
  ...
  **/
  ...
  public DeleteDipJob retrieveRequestId(Long retrieveRequestId) {
  ...
  **/
  ...
  public DeleteDipJob retrieveJobIds(List<Long> retrieveJobIds) {
    
    this.retrieveJobIds = retrieveJobIds;
    return this;
  }

  public DeleteDipJob addRetrieveJobIdsItem(Long retrieveJobIdsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeleteDipJob deleteDipJob = (DeleteDipJob) o;
    return Objects.equals(this.jobId, deleteDipJob.jobId) &&
        Objects.equals(this.retrieveRequestId, deleteDipJob.retrieveRequestId) &&
        Objects.equals(this.retrieveJobIds, deleteDipJob.retrieveJobIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobId, retrieveRequestId, retrieveJobIds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteDipJob {\n");
